          ...
          <div className="flex items-center justify-between mb-2">
            <div className="flex items-center gap-4 text-gray-800">
              ...
              <svg
                ...
                className={`w-6 h-6 cursor-pointer drop-shadow-sm transition-colors ${
                  liked ? "text-red-500" : "hover:text-gray-600 text-gray-800"
                }`}
              ...
              <svg className="w-6 h-6 hover:text-gray-600 cursor-pointer drop-shadow-sm" fill="none" stroke="currentColor" viewBox="0 0 24 24">

...
const About = () => {
  ...
  <div className="space-y-6 text-lg md:text-xl font-sans text-foreground/90 leading-relaxed text-center max-w-3xl">
    <div>
      I&apos;m a{" "}
    ...
    <div>
      ...
      that most people don&apos;t notice but definitely feel. I care about
      structure, performance, and writing code that future me won&apos;t
      hate.
    </div>
    ...
    <div>
      ...
      simpler and smarter. I believe great software is built at the
      intersection of curiosity, consistency, and{" "}
